...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2023/FlipFlops/FlipFlops.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKFF_s.tcl
